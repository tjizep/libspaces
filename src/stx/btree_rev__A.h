	...
	private:
		...
		typename node::ptr load(stream_address w, node* preallocated, stream_address loader = 0, nst::u16 slot = 0) {
			...
			if (level == 0) { // its a surface
				...
				if (is_preall/home/pirow/Desktop/spaces/src/stx/btree_rev__A.hocated) {
...
/home/pirow/Desktop/spaces/src/stx/btree_rev__A.h
			/// an iterator intializer pair
		...
		public:
			...
			inline bool from_initializer(const initializer_pair& init) {
				...
				return false;/home/pirow/Desktop/spaces/src/stx/btree_rev__A.h
